  ...
  return (
    <div className="relative">
      <Link to="/checkout-page">
        <svg
          className="z-20 w-8 h-8 text-gray-700 fill-current"
          viewBox="0 0 20 20"
          fill="none"
        ...
        {quantity > 0 ? (
          <span className="box-border absolute top-0 right-0 z-50 px-1 -mt-2 -mr-4 font-bold text-gray-100 bg-gray-900 rounded-full">
            {quantity}
          </span>
        ) : null}
      </Link>
